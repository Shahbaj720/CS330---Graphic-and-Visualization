...
void SceneManager::LoadSceneTextures()
{
	...
	bReturn = CreateGLTexture(
		"../../Utilities/textures/rusticwood.png",
		"wood"
	);
	bReturn = CreateGLTexture(
		"../../Utilities/textures/gold.png",
		"gold"
	);
	bReturn = CreateGLTexture(
	...
	bReturn = CreateGLTexture(
		"../../Utilities/textures/sglass.png",
		"sglass"
	);

	bReturn = CreateGLTexture(
		"../../Utilities/textures/cwood.png",
		"cwood"
	);
